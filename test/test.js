...
tape( 'the function returns an iterator protocol-compliant object (callback)', function test( t ) {
	...
	t.strictEqual( FLG, true, 'returns expected value' );
	t.end();

	function clbk( v ) {
		FLG = true;
		t.strictEqual( v, values[ values.length-1 ], 'returns expected value' );
	}
});
...
tape( 'the function supports specifying the callback execution context', function test( t ) {
	...
	t.strictEqual( ctx.FLG, true, 'returns expected value' );
	t.end();
